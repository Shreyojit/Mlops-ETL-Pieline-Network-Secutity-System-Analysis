...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            train_arr = np.column_stack((transformed_input_train_feature, target_feature_train_df.values))
            test_arr = np.column_stack((transformed_input_test_feature, target_feature_test_df.values))
